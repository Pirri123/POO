...
// Atributos
     ...
     */
    public Perro (String raza, int patas, String reproduccion) {
      super (raza);  
      this.patas = patas;
    ...
    public void getCuerpo() {
        System.out.println("Los perros tienen " + this.patas + " patas");
    }

    @Override
    public void getReproduccion() {
        System.out.println("Los perros son " + this.reproduccion);
    }
